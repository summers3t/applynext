...
function prop(props, key, flags2, fallback2) {
  ...
  var d = ((flags2 & PROPS_IS_IMMUTABLE) !== 0 ? derived : derived_safe_equal)(getter);
  if (bindable) get(d);
  return function(value, mutation) {
    if (arguments.length > 0) {
...
var _anchor, _hydrate_open, _props, _children, _effect, _main_effect, _failed_effect, _is_creating_fallback, _Boundary_instances, run_fn;
var Boundary = class {
  /**
...
//# sourceMappingURL=chunk-E32PHD4Q.js.map
